#!/usr/bin/env python3
"""
CSS Stylesheet and Theme Definitions for SUPER DESKTOP.
Implements modern Omarchy glassmorphism, accent glows, tactile sticky notes, and sleek mini-terminal cards.
"""
...
.hud-bar {
    background-color: rgba(20, 26, 43, 0.90);
...
.note-rose .note-header {
    background-color: #F472B6;
    border-bottom: 1px solid rgba(219, 39, 119, 0.25);
}
...
.note-dark {
    background-color: rgba(26, 31, 48, 0.95);
    color: #F1F5F9;
    border: 1px solid rgba(255, 255, 255, 0.12);
}
.note-dark .note-header {
    background-color: rgba(36, 43, 66, 0.95);
    border-bottom: 1px solid rgba(255, 255, 255, 0.08);
}
.note-dark text { color: #F1F5F9; }
.note-dark .note-header-btn:hover {
...
def apply_styles() -> None:
    """Load and apply CSS into default GTK display."""
